...
fic=open("C:/Users/alexi/Desktop/SAE 15/test.csv", "w")
...
while prog == 1 : #Tant qu'il est à 1, le programme fonctionne
    for event in ress:
        if event.startswith('11:42'): #évenement qui commence par "11:42" (ils commencent tous par 11:42)
            ...
            if len(texte) > 1: #s'il y a plus de 1 partie à partir du crochet
                flag1=texte[1].split("]") #on prend ce qui y après le premier crochet et on coupe au deuxième crochet
